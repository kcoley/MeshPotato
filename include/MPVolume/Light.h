...
namespace MeshPotato {
	namespace MPVolume {
		...
		class FrustumLight : public Light {
			public:
				static boost::shared_ptr<FrustumLight> Ptr(boost::shared_ptr<MeshPotato::MPVolume::FrustumGrid> _frustum, MeshPotato::MPUtils::Color _color);

				FrustumLight(boost::shared_ptr<MeshPotato::MPVolume::FrustumGrid> _frustum, MeshPotato::MPUtils::Color _color);
